...
/** Conferma dopo l'invio di una richiesta di disponibilità.
 *
 *  La usano due form: quello della home e quello della landing pubblicitaria.
 *  Sta nel gruppo marketing e non più sotto `/disponibilita` perché da qui in
 *  poi i link in uscita non sono più una conversione persa — la conversione è
 *  appena avvenuta, e chi vuole guardarsi il sito deve poterlo fare.
