...
/* ============================================================
   La home precedente, messa da parte il 17 settembre 2026.

   Non è stata buttata: la home nuova è una pagina da contatti — CAP,
   email, telefono — mentre questa vendeva, con la comparativa, i tre
   piani a prezzo pieno e il checkout diretto. Se il nuovo taglio non
   porta i lead che deve portare, qui c'è la versione da cui si
   riparte, intera e funzionante.

   Fuori dall'indice, e deve restarci: due pagine che raccontano lo
   stesso servizio con parole diverse si tolgono posizioni a vicenda,
   e questa non deve rubare il posto alla home. Non è nel piè di
   pagina, non è in sitemap: ci si arriva solo scrivendo l'indirizzo.
   ============================================================ */

export const metadata: Metadata = {
  title: "Home precedente (archivio)",
...
export default function HomePrecedente() {
  return (
    <>
      {/* Chi apre questo indirizzo vede una home che non è la home: senza una
          riga che lo dica, la prima reazione è pensare che il sito sia rimasto
          indietro. */}
      <div className="border-b border-[#C9881F]/30 bg-[#C9881F]/10">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-2 px-5 py-3">
          <p className="text-sm font-semibold text-navy">
            <strong>Versione precedente della home</strong> — tenuta da parte, non indicizzata.
          </p>
          <Link href="/" className="font-display text-sm font-extrabold text-blue hover:underline">
            Vai alla home attuale →
          </Link>
        </div>
      </div>
