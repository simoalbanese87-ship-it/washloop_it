 ...
 *
 * **Niente prova gratuita qui, di proposito.** La prima settimana gratis si
 * concede una persona alla volta, dal link di abbonamento personalizzato
 * (`createCustomSubscriptionLink`): è un'offerta che si fa al telefono mentre
 * si concorda il prezzo, non una casella accesa a listino per chiunque passi.
 */
