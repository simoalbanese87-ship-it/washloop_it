      ...
      <form onSubmit={submit} className="mt-3 grid gap-2">
        ...
        <label className="mt-1 flex items-start gap-2 text-xs font-bold text-navy">
          <input
            ...
            className="mt-0.5 accent-[#2b7fd4]"
          />
          <span>
            Prima settimana gratuita
            <span className="block font-medium text-muted">
              Oggi non paga nulla: la carta resta a garanzia e l&apos;addebito parte il giorno dopo la riconsegna del
              primo ritiro. Se non prenota entro {GIORNI_PER_PRENOTARE} giorni, parte comunque il{" "}
              {fmtDate(paracadute(new Date().toISOString()))}.
            </span>
          </span>
        </label>
        <button
